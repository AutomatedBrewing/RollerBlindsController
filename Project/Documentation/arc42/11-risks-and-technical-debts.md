...
| RISK-T-04 | Technical | Shutter motor type incompatibility (speed/torque variance defeats one fixed timing profile) | medium | medium | **major** | open | System Architect | Per-installation configurable `TravelTime`; `VerifyTimeBasedOperation` |
