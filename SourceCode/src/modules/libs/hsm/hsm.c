...
state_machine_result_t dispatch_event(state_machine_t *const pState_Machine[], uint32_t quantity
                                      ...
                                      ,
                                      state_machine_event_logger event_logger, state_machine_result_logger result_logger
...
)
{
    ...
    {
        if (pState_Machine[index]->Event == NULL)
        {
            index++;
            continue;
        }
       ...
       // Call the state handler.
            ...
            case EVENT_HANDLED:
                ...
                pState_Machine[index]->Event = NULL;
 ...
 *
 */
extern state_machine_result_t switch_state(state_machine_t *const pState_Machine, const state_t *const pTarget_State)
{
